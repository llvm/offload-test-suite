...
public:
  ...
  llvm::Error createResource(Resource &R, InvocationState &IS) {
    // TODO: This should not be in a function called create buffer. A sampler is
    // not a buffer. We should rename this function and other related function
    // to something like create resource.
    //
